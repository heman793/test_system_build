...
class New_Order_Msg(ConfigCommon):
    ...
    def new_order_message(self, clientid, account_type):
        file = '%s_%s_peg.csv' % (account_type, strategy)
        test_type = 'all'
        ...
        msg_algo.AlgoNameWired = 0
        msg_algo.PeggedLevel = 100
        msg_algo.ParticipationRate = 0.02
        msg_algo.Interval = 2
        ...
        msg_order_child.OrderAccount = account_type
...
if __name__ == "__main__":
    ...
    new_msg.new_order_message(clientid, account_type)