...
class New_Order_Msg(ConfigCommon):
    ...
    def new_order_message(self):
        ...
        file = '%s_%s_%s_oib.csv' % (clientid, future_account, strategy)
        ...
        msg_child_algo.AlgoNameWired = 18
        msg_child_algo.max_tolerance_tick = 2
        msg_child_algo.imbalance_threshold = 1.5
        msg_child_algo.expire_timespan = 60
        msg_child_algo.ParticipationRate = 0.1
        ...
        for ind in df.index.values:
            ...
            msg_child1.OrderAccount = future_account
            ...
            msg_child2.OrderAccount = future_account
            ...
            msg_order.OrderAccount = future_account
