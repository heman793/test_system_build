...
def strategy_para_change_info_request_msg(strategy_name, is_enable=False):
    ...
    parameter_item = msg.Parameter.add()
    parameter_item.Key = "tq.steady_return.max_long_position"
    parameter_item.Value = "2"
    parameter_item = msg.Parameter.add()
    parameter_item.Key = "tq.steady_return.max_short_position"
    parameter_item.Value = "2"
    parameter_item = msg.Parameter.add()
    parameter_item.Key = "tq.steady_return.qty_per_trade"
    parameter_item.Value = "4"
