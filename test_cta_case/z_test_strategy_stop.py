...
class TestCtaStrategy(unittest.TestCase):
    ...
    def test_BBreaker_strategy_stop(self):
        test_case_no = 'cta0001'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_BollingerBandReversion_strategy_stop(self):
        test_case_no = 'cta0002'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_BreakBandDync_strategy_stop(self):
        test_case_no = 'cta0003'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_CCIMktRecg_strategy_stop(self):
        test_case_no = 'cta0004'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_CCIOsc_strategy_stop(self):
        test_case_no = 'cta0005'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_CCIRvs_strategy_stop(self):
        test_case_no = 'cta0006'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_Donchian_strategy_stop(self):
        test_case_no = 'cta0007'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_FollowTrendDync_strategy_stop(self):
        test_case_no = 'cta0008'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_Hans_strategy_stop(self):
        test_case_no = 'cta0009'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_HighLowBandADX_strategy_stop(self):
        test_case_no = 'cta0010'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_PriceVolRatio_strategy_stop(self):
        test_case_no = 'cta0011'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no)

    def test_VolumeBreakthrough_strategy_stop(self):
