...
class TestATPStrategy(unittest.TestCase):
    ...
    def test_CalendarMA_SU_strategy_stop(self):
        test_case_no = 'st0002'
        app_name = 'CalendarMA'
    ...
    @pytest.mark.CalendarMA
    def test_CalendarMA_Transfer_strategy_stop(self):
        test_case_no = 'st0003'
        app_name = 'CalendarMA'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    def test_CalendarSpread_SU_strategy_stop(self):
        test_case_no = 'st0004'
    ...
    def test_ETFArb_illiquid_strategy_stop(self):
        test_case_no = 'st0005'
    ...
    @pytest.mark.ETFStrategy
    def test_ETFArb_liquid_strategy_stop(self):
        test_case_no = 'st0006'
        app_name = 'ETFStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    def test_SHSFArbMerge_default_strategy_stop(self):
        test_case_no = 'st0007'
        app_name = 'SFStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.SFStrategy
    def test_SHSFArbRedPur_default_strategy_stop(self):
        test_case_no = 'st0008'
        app_name = 'SFStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.SFStrategy
    def test_SHSFArbSplit_default_strategy_stop(self):
        test_case_no = 'st0009'
        app_name = 'SFStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    def test_IndexArb_SH000905_strategy_stop(self):
        test_case_no = 'st0010'
    ...
    @pytest.mark.IndexArbStrategy
    def test_IndexArb_SHSZ300_strategy_stop(self):
        test_case_no = 'st0011'
        app_name = 'IndexArbStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.IndexArbStrategy
    def test_IndexArb_SSE50_strategy_stop(self):
        test_case_no = 'st0012'
        app_name = 'IndexArbStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.IndexArbStrategy
    def test_IndexArbETF_SH000905_strategy_stop(self):
        test_case_no = 'st0013'
        app_name = 'IndexArbStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.IndexArbStrategy
    def test_IndexArbETF_SHSZ300_strategy_stop(self):
        test_case_no = 'st0014'
        app_name = 'IndexArbStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.IndexArbStrategy
    def test_IndexArbETF_SSE50_strategy_stop(self):
        test_case_no = 'st0015'
        app_name = 'IndexArbStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    def test_MarketMaking1_SR_strategy_stop(self):
        test_case_no = 'st0016'
    ...
    @pytest.mark.OptionStrategy
    def test_MarketMaking1_SSE50_strategy_stop(self):
        test_case_no = 'st0017'
        app_name = 'OptionStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.OptionStrategy
    def test_MarketMaking1_m_strategy_stop(self):
        test_case_no = 'st0018'
        app_name = 'OptionStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.OptionStrategy
    def test_PutCallParity_SR_strategy_stop(self):
        test_case_no = 'st0019'
        app_name = 'OptionStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.OptionStrategy
    def test_PutCallParity_SSE50_strategy_stop(self):
        test_case_no = 'st0020'
        app_name = 'OptionStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    @pytest.mark.OptionStrategy
    def test_PutCallParity_m_strategy_stop(self):
        test_case_no = 'st0021'
        app_name = 'OptionStrategy'
        self.stop_strategy(test_case_no)
        self.genaral_test_xxx_testcase(test_case_no, app_name)
    ...
    def test_CloseLockedPosition_SU_strategy_stop(self):
        test_case_no = 'st0022'
